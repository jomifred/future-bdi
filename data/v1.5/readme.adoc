...
- _rc_ =< 0.3 is not a good option for any cases. Although the efficiency is quite good, the few times the agent succeeded to cross the grid, it did it quite fast, this result is unlikely (see effectiveness).
