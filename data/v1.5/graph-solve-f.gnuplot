...
version="v4"
fileM  ="runs/stats-g3-solve_f-5walls-".version.".csv"
fileR  ="runs/stats-g3-random-5walls-".version.".csv"
fileTOM="runs/stats-g3-solve_f-5walls-".version."-to.csv"
...
do for [rc in RCS] {
    ...
    set output "graphs/solve-f-states-".rc."-".version.".pdf"
...
#
set output "graphs/solve-f-a-eff-".version.".pdf"
set key bottom right
unset y2label
unset y2tics
...
set output "graphs/solve-f-a-cost-".version.".pdf"
unset ylabel
unset ytics
set key top right
...
set output "graphs/solve-f-a-success-".version.".pdf"
